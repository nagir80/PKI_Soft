...
extern void form_7D(BinCharData *bchar_data); // 0x7D
extern void form_7E(BinCharData *bchar_data); // 0x7E
extern void form_7F(BinCharData *bchar_data); // 0x7F
//---------------------------------------------------------------------------
 ...
 */
		...
		comPort_rec = new COM_Tranceiver(com_rec, cp_Event);
...
////////////////////////////////////////////////////////////////////////////////
//0x7c_4
		  comPort_rec->getSettings()->getPrt()->get_bwr()->add(0x7D, form_7D);
		  comPort_rec->getSettings()->getPrt()->add_msg(0x7D);
		  comPort_rec->size_wr = comPort_rec->getSettings()->getPrt()->code(comPort_rec->bufwr);
		  ResumeThread(comPort_rec->getTrHandle());
		  Sleep(50);
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//0x7c_4
		  comPort_rec->getSettings()->getPrt()->get_bwr()->add(0x7E, form_7E);
		  comPort_rec->getSettings()->getPrt()->add_msg(0x7E);
		  comPort_rec->size_wr = comPort_rec->getSettings()->getPrt()->code(comPort_rec->bufwr);
		  ResumeThread(comPort_rec->getTrHandle());
		  Sleep(50);
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
//0x7c_4
		  comPort_rec->getSettings()->getPrt()->get_bwr()->add(0x7F, form_7F);
		  comPort_rec->getSettings()->getPrt()->add_msg(0x7F);
		  comPort_rec->size_wr = comPort_rec->getSettings()->getPrt()->code(comPort_rec->bufwr);
		  ResumeThread(comPort_rec->getTrHandle());
		  Sleep(50);
////////////////////////////////////////////////////////////////////////////////
